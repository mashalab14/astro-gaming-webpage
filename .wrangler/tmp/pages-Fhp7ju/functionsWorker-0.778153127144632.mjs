...
async function onRequestPost(context) {
  ...
  try {
    if (db) {
      ...
      ).bind(userId, userAgent, ipHash).run();
    }
  } catch (err) {
...
// ../.wrangler/tmp/pages-Fhp7ju/functionsRoutes-0.8758148485360229.mjs
var routes = [
  {
    routePath: "/api/user",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-0YQ0TQ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-0YQ0TQ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.778153127144632.mjs.map
